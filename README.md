...
```
{
  "canisters": {
    "virtual_garden": {
      ...
      "candid_gen": "http",
      "build": "npx azle virtual_garden",
      "wasm": ".azle/virtual_garden/virtual_garden.wasm",
      "gzip": true,
      "metadata": [
        {
            "name": "candid:service",
...
```
where `virtual_garden` is the name of the canister.
...
Example:
- `dfx canister id virtual_garden`
Response:
```
